 ...
 */
final class Version20210802111145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE circuit (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, difficulte VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, attribut INT NOT NULL, image LONGBLOB DEFAULT NULL, trajectoire JSON DEFAULT NULL, INDEX IDX_1325F3A6BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, nbpersonnes INT NOT NULL, commentaire LONGTEXT DEFAULT NULL, debutdate DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', findate DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', cin INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE site (id INT AUTO_INCREMENT NOT NULL, categoriesite_id INT NOT NULL, nom VARCHAR(255) NOT NULL, icon LONGBLOB DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, map LONGTEXT DEFAULT NULL, INDEX IDX_694309E489A85BFC (categoriesite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
